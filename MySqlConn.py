    ...
    def __get_conn():
        ...
        if Mysql.__pool is None:
            __pool = PooledDB(creator=MySQLdb,
                              mincached=config.dbinfo['mincached'],
                              maxcached=config.dbinfo['maxcached'],
                              host=config.dbinfo['host'],
                              port=config.dbinfo['port'],
                              user=config.dbinfo['user'],
                              passwd=config.dbinfo['pwd'],
                              db=config.dbinfo['db'],
                              use_unicode=config.dbinfo['use_unicode'],
                              charset=config.dbinfo['encoding'],
